...
public class TrackService extends AsyncTask<String, Void, List<Track>> {
    ...
    public TrackService(ITrackModel trackModel) {
    ...
    protected List<Track> doInBackground(String... strings) {
        ...
        try {
            ...
            if(responseCode == HttpURLConnection.HTTP_OK){
                ...
                Gson gson = new Gson();
                Type type = new TypeToken<TrackResult>() {}.getType();
                TrackResult trackResult = (TrackResult) gson.fromJson(responseString, type);
                tracks = trackResult.getTracksResult();
            }
        }catch (Exception e){
            e.printStackTrace();
        }finally {
    ...
    protected void onPostExecute(List<Track> tracks) {
        ...
        trackModel.onTrackServiceListener(tracks);
    }
